                ...
                <svg
                  ...
                  :class="[
                    $route.path === item.path
                      ...
                      : 'text-gray-500 dark:text-slate-400 group-hover:text-gray-600 dark:group-hover:text-slate-300 w-[18px] h-[18px]',
                  ]"
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <header class="flex items-center justify-between px-4 lg:px-6 py-3 bg-transparent shrink-0">
        ...
        <div class="ml-auto flex items-center gap-2">
          ...
          <button
            @click="onLogout"
            class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium text-gray-600 dark:text-slate-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-500 dark:hover:text-red-400 transition-colors"
            title="Logout"
          >
